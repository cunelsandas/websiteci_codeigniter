...
<div id="activity-yota">


<?php
$tablename="tb_activity_yota";  //ชื่อ ตารางข้อมูล
$picfolder="fileupload/activity_yota/";  // ชื่ีอโฟลเดอร์เก็บภาพ
...
if($no<>""){
	include"modules/activity_yota/activity_yota_view.php";
}else{
