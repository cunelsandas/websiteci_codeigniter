...
<div id="activity-money">


<?php
$tablename="tb_activity_money";  //ชื่อ ตารางข้อมูล
$picfolder="fileupload/activity_money/";  // ชื่ีอโฟลเดอร์เก็บภาพ
...
if($no<>""){
	include"modules/activity_money/activity_money_view.php";
}else{
