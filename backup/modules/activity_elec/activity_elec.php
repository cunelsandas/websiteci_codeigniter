...
<div id="activity-elec">


<?php
$tablename="tb_activity_elec";  //ชื่อ ตารางข้อมูล
$picfolder="fileupload/activity_elec/";  // ชื่ีอโฟลเดอร์เก็บภาพ
...
if($no<>""){
	include"modules/activity_elec/activity_elect_view.php";
}else{
