<!--<table width="100%" cellpadding="0" cellspacing="1" border="0" style="margin-top:5px;" class="tbl-border1">
	<tr>
			<td><img src="images/mn_otop.png"/></td>	
	</tr>
</table>-->
<div id="otop">
<BR><BR>
...
<?php
$tablename="tb_otop";  //ชื่อ ตารางข้อมูล
$picfolder="fileupload/otop/";  // ชื่ีอโฟลเดอร์เก็บภาพ
...
if($no<>""){
	include"modules/otop/otop_view.php";
}else{
