		 ...
		 <?php // พนักงานเจ้าหน้าที่  บล๊อกการแสดง 1
				...
				if(mysqli_num_rows($rs)>0){
						while($row=mysqli_fetch_array($rs)){
							...
							$history=!empty($row['history'])?"<br><a href=\"#\" onclick=\"open_new_window('../modules/popup/history_popup.php?no=".encode64($row['no'])."&tb=".encode64('tb_header')."&p=".encode64('header')."');\"><img src=\"images/document_icon.png\"></a>":"";
