...
<center>
<?php
$tablename="tb_doc1";  //ชื่อ ตารางข้อมูล
$picfolder="fileupload/doc1/";  // ชื่ีอโฟลเดอร์เก็บภาพ
...
<TD  class="tbl1" align=left width=520 {word-wrap: break-word;} ><?=$row['subject']?></b><BR>&nbsp;&nbsp;
		<?php
