...
if($no<>""){
	include"modules/middleprice/middleprice_view.php";
}else{
...
echo"<tr>";
echo"<th width=\"80%\" align=\"center\" class=\"tbl2\">หัวข้อ</td>";
if($showdate=="yes"){
echo"<th align=\"center\" class=\"tbl2\">วันที่</td>";
}
echo"</tr>";
while($arr = mysqli_fetch_array($Query)){
	...
	echo"<td style=\"background:$bgcolor;\"><a class=list href=index.php?_mod=".encode64($mod)."&no=".encode64($arr['no']).">".$arr['subject']."</a></td>";
	if($showdate=="yes"){
