...
<tr>
		...
		<table width="250" border="0" cellpadding="0" cellspacing="0">
			...
			?>
				...
				<td width="260" align="center"><img src="images/board/<?php echo "".$arr['no']."-1.JPG";?>" width="135" height="165"><br><br><font  color="#0033FF"><?php echo $arr['name'];?><br><?php echo $arr['position'];?></font></td>
	...
	<tr>
		...
		<table width="250" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
			  <?php  // รองประธานสภา
				$sqlhead="Select * From tb_board Where sid='2' And status='1'";
				//$sql="Select * From tb_officer Where offid='".$_GET['ID']."'";
				$rshead=rsQuery($sqlhead);
				$arr=mysql_fetch_array($rshead)
			?>
...
<tr>
<td>
<IMG SRC="images/board1.png" WIDTH="200" HEIGHT="40" BORDER="0" ALT="">
	<table border="0" width="100%">	
	...
	<tr>
<td>
	<IMG SRC="images/board2.png" WIDTH="200" HEIGHT="40" BORDER="0" ALT="">
	<table border="0" width="100%">	
	
		<tr>
		 <?php // สมาชิกเขต 2
	$i=1;
	$sql="Select * From tb_board Where sid='5' And status='1'";
	$rs=rsQuery($sql);
	if(mysql_num_rows($rs)>0){
		while($row=mysql_fetch_array($rs)){
			echo"<td>";
			echo"<table style=\"margin:10px;\" class=\"tbl-border\" border=\"0\">";
				echo"<tr>";
					echo"<td align=\"center\" width=140px><img src=\"images/board/".$row['no']."-1.JPG\" width=\"135\" height=\"165\"><br/><br/><font color=\"#FF6600\">".$row['name']."<br/>".$row['position']."</font>";
				echo"</tr>";
			echo"</table>";
			echo"</td>";
			if($i==3){
