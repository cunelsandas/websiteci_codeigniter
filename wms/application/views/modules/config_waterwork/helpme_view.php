...
$Headers .= "X-Mailer: PHP mailer\r\n" ;
	...
	echo"<script>alert('$msg');window.location.href='direct?_modid=".$modid."&_mod=".$_GET['_mod']."';</script>";
...
if(isset($_POST['btadd'])){
    ...
    $strupdate="Update tb_waterwork SET typewb='".$_POST['f_status']."',result='$text',updatetime='".date("c")."' Where id='".$_GET['no']."'";

    $rsupdate=rsQuery($strupdate);

    if($rsupdate){

        echo"<script>alert('บันทึกข้อมูลเรียบร้อย');window.location.href='waterwork?_modid=".$modid."&_mod=".$_GET['_mod']."';</script>";
...
$sql="Select * From tb_waterwork Where id='".$_GET['no']."'";
...
$sql1="Select * From tb_files_image_waterwork Where image_key='".$row['image_key']."'";
...
<div class="container-fluid" style="margin-left: 10%">
    ...
    <div class="row">
        ...
        <div class="w3-panel w3-border col-md-10">
            ...
            <div class="panel-body">
                ...
                <p>เลขที่คำร้อง : <?php echo $row['id'];?></p>

                <p>วันที่แจ้ง : <?php echo DateTimeThai($row['datepost']);?>&nbsp;&nbsp; IP Address : <?php echo $row['ip'];?></p>
                ...
                if ($row['number'] != "") {
                    ...
                    echo "<p>เลขบัตรประชาชน : ".$row['number']." </p>";
                ...
                <p>อีเมล์/โทรศัพท์ : <?php echo $row['email'];?></p>
    ...
    <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="f_status" name="f_status" class="form-control">
                    ...
                    $sqls = "select * from tb_waterwork_process";
        ...
        <button class="btn btn-info" type="submit" name="btadd">บันทึก</button>&nbsp;&nbsp;
              ...
              <a class="btn btn-dark"  href="<?php echo base_url('reportswaterwork/'. $row['id'] .'?id='. $row['id']) ;?>" target="_Blank">พิมพ์คำแจ้งซ่อมประปา</a>&nbsp;&nbsp;
        </div>
