...
if(isset($_POST['btadd'])){
    ...
    $strupdate="Update tb_help_maps SET typewb='".$_POST['f_status']."',result='$text',updatetime='".date("c")."' Where id='".$last."'";

    $rsupdate=rsQuery($strupdate);

    if($rsupdate){

        echo"<script>alert('บันทึกข้อมูลเรียบร้อย');window.location.href='../helpme'</script>";
...
$sql="Select * From tb_help_maps Where id='".$last."'";
