                                    ...
                                    <ul>
                                        ...
                                        foreach ($rsWg as $WgKey => $WgVal):
                                            ...
                                            <div class="picbox">
                                                ...
                                                <br>
                                                <a href="<?php echo $site_view . $WgVal['no']; ?>"
                                                   class="btn btn-warning text-white btn-sm">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="<?php echo $site_remove . $WgVal['no']; ?>"
                                                   class="btn btn-danger btn-remove text-white btn-sm">
                                                        ...
                                                        if ($numrow3 > 0):
                                                            ...
                                                            foreach ($rs AS $dataWg): $y += 1;
                                                                ...
                                                                <div class="picbox">
                                                                    ...
                                                                    <br>
                                                                    <a href="<?php echo $site_view . $dataWg['no']; ?>"
                                                                       class="btn btn-warning text-white btn-sm">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a href="<?php echo $site_remove . $dataWg['no']; ?>"
                                                                       class="btn btn-danger btn-remove text-white btn-sm">
                                                                        <i class="fa fa-bitbucket"></i>
                                                                    </a>
                                                                    <br>
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                foreach ($rsOff AS $dOff): $path = isset(search_img($table_name, $dOff['no'])[0]['filename']) ? search_img($table_name, $dOff['no'])[0]['filename'] : '' ?>
                                                                                    <div class="picbox">
                                                                                        ...
                                                                                        <br>
                                                                                        <a href="<?php echo $site_view . $dOff['no']; ?>"
                                                                                           class="btn btn-warning text-white btn-sm">
                                                                                            <i class="fa fa-edit"></i>
                                                                                        </a>
                                                                                        <a href="<?php echo $site_remove . $dOff['no']; ?>"
                                                                                           class="btn btn-danger btn-remove text-white btn-sm">
                                                                                            <i class="fa fa-bitbucket"></i>
                                                                                        </a>
                                                                                        <br>
