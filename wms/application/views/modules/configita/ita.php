...
<div class="card card-shadow" id="CardDetail">
	...
	<table width='100%' style="text-align: center;margin-top: 3%;">
			<tr style="margin-left:%">
				<td><?php echo "<a style='text-decoration: none;color: white' href='ita?_modid=".$modid."&_mod=".$mod."&type=ita_menu'><button class='button'>หัวข้อหลัก</button></a>";?></td>
				<td><?php echo "<a style='text-decoration: none;color: white' href='ita?_modid=".$modid."&_mod=".$mod."&type=ita_submenu'><button class='button'>หัวข้อย่อย</button></a>";?></td>
				<td><?php echo "<a style='text-decoration: none;color: white' href='ita?_modid=".$modid."&_mod=".$mod."&type=ita_detail'><button class='button'>รายละเอียด</button></a>";?></td>
	</table>
            </div>
