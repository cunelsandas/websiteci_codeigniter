                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="menu_name" id="menu_name"
                               value="<?php echo IsVal($set_data['menu_name']) ?>">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-lg-2 text-lg-right">
                    ...
                    <div class="col-lg-8">
                        <select name="group_id" id="group_id" class="form-control">
                            ...
                            <?php foreach ($group_menus as $gKey => $gVal): ?>
                                <option value="<?php echo $gVal['group_id'] ?>" <?php echo IsSelect($set_data['group_id'], $gVal['group_id']) ?>><?php echo $gVal['group_name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
