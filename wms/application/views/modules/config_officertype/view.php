        ...
        <form action="<?php echo $site; ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="office_type_name" id="office_type_name"
                               value="<?php echo IsVal($set_data['office_type_name']) ?>">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-lg-2 text-lg-right">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-8">
                        <textarea name="detail" id="detail" cols="30" rows="10" class="edit-text">
                            <?php echo IsVal($set_data['detail']); ?>
                        </textarea>
                    </div>
                </div>
                <div class="row mb-2">
