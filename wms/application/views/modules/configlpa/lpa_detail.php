<?php
	...
	if($rsShow || msyqli_num_rows($rsShow)>0){
		while($data=mysqli_fetch_assoc($rsShow)){
			...
			$link=$data['link'];
			$strTableDetail .="<tr><td style='padding: 10px;border-bottom: solid 1px black' align='center'>$menuname</td><td style='padding: 10px;border-bottom: solid 1px black' align='center'>$submenuname</td><td style='padding: 10px;border-bottom: solid 1px black' align='center'>$name</td><td style='padding: 10px;border-bottom: solid 1px black;background-color: pink'  align='center'>$listno</td><td style='padding: 10px;border-bottom: solid 1px black' align='center'>$modname</td><td style='border-bottom: solid 1px black;color: red;border-right: solid 1px black;border-left: solid 1px black;padding-left: 3px'>$link</td><td style='padding: 10px;border-bottom: solid 1px black' align='center' align='center'><a class=\"btn btn-warning btn-sm text-white\" href=\"lpa?_modid=".$modid."&_mod=".$_GET['_mod']."&type=".$type."&id=".$id."\"><i class=\"fa fa-edit btn-add\"></i></a>&nbsp;&nbsp;&nbsp;<a class=\"btn btn-danger btn-sm text-white\" href=\"lpa?_modid=".$modid."&_mod=".$_GET['_mod']."&type=".$type."&del=".$id."\" onclick=\"return confirm('คุณต้องการลบรายการนี้ใช่หรือไม่ ?');\"><i class=\"fa fa-trash-o btn-remove\"></i></a></td>";
		}
...
<div class='content-box'>
    <p align="center" style="margin-top: 2%;text-decoration: underline;font-size: 1.3rem;font-weight: bold">หัวข้อ"ย่อย"การประเมิน LPA</p>
	<hr>
		<div class='content-input'>
			<table width='100%'>
				...
				<tr>
					...
					<td><input type='submit' name='btsave' value='เพิ่มหัวข้อย่อย'></td>
				</tr>
			</table>
		</div>
