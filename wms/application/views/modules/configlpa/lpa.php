    ...
    <div class="row mb-2">
        <div class="col-lg-12">
            <div class="input-group">
                ...
                <table width='100%' style="text-align: center;margin-top: 3%;">
			<tr>
				<td><?php echo "<a style='text-decoration: none;color: white' href='lpa?_modid=".$modid."&_mod=".$mod."&type=lpa_menu'><button class='button'>หัวข้อหลัก</button></a>";?></td>
				<td><?php echo "<a style='text-decoration: none;color: white' href='lpa?_modid=".$modid."&_mod=".$mod."&type=lpa_submenu'><button class='button'>หัวข้อรอง</button></a>";?></td>
                <td><?php echo "<a style='text-decoration: none;color: white' href='lpa?_modid=".$modid."&_mod=".$mod."&type=lpa_detail'><button class='button'>หัวข้อย่อย</button></a>";?></td>
                <td><?php echo "<a style='text-decoration: none;color: white' href='lpa?_modid=".$modid."&_mod=".$mod."&type=lpa_detail2'><button class='button'>รายละเอียด</button></a>";?></td>
	</table>
