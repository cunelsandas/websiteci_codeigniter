...
if(isset($_POST['btwb'])){
	...
	if($chkver<>$_POST['txtver']){
		...
		$sql="INSERT INTO tb_direct(subject,detail,postby,datepost,ip,status) Values('".$_POST['txtsubject']."','".$_POST['detail1']."','".$_SESSION['name']."','".$_POST['dateInput']."','".$_SERVER['REMOTE_ADDR']."','0')";
		...
		$updatetran=UpdateTrans('tb_direct','add',$_SESSION['username'],'ID:'.$_POST['txtsubject']);
