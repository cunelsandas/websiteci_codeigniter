...
if(isset($_POST['btadd'])){
    ...
    $strupdate="Update tb_direct SET typewb='".$_POST['f_status']."',result='$text',updatetime='".date("c")."' Where id='".$_GET['no']."'";

    $rsupdate=rsQuery($strupdate);

    if($rsupdate){

        echo"<script>alert('บันทึกข้อมูลเรียบร้อย');window.location.href='direct?_modid=".$modid."&_mod=".$_GET['_mod']."';</script>";
...
$sql="Select * From tb_direct Where id='".$_GET['no']."'";
...
$sql1="Select * From tb_files_image_direct Where image_key='".$row['image_key']."'";
...
<div class="container-fluid" style="margin-left: 10%">
    ...
    <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="f_status" name="f_status" class="form-control">
                    ...
                    $sqls = "select * from tb_direct_process";
        ...
        <button class="btn btn-info" type="submit" name="btadd">บันทึก</button>&nbsp;&nbsp;
              ...
              <a class="btn btn-default"  href="<?php echo base_url('reportsdirect/'. $row['id'] .'?id='. $row['id']) ;?>" target="_Blank">พิมพ์คำร้อง</a>&nbsp;&nbsp;
        </div>
