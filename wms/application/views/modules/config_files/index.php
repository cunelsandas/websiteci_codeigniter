            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4 pl-lg-1">
                        <select name="file_type" id="file_type" class="form-control select">
                            <option value="0">ยังไม่ได้กำหนดประเภทเอกสาร</option>
                            <?php foreach ($file_type as $ftKey => $ftVal): ?>
                                <option value="<?php echo $ftVal['file_type_id'] ?>"><?php echo $ftVal['file_type_name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
