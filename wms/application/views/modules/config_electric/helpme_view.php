...
if(isset($_POST['btadd'])){
    ...
    $strupdate="Update tb_electric SET typewb='".$_POST['f_status']."',result='$text',updatetime='".date("c")."' Where id='".$_GET['no']."'";
...
$sql="Select * From tb_electric Where id='".$_GET['no']."'";
...
<div class="container-fluid" style="margin-left: 10%">
    ...
    <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="f_status" name="f_status" class="form-control">
                    ...
                    $sqls = "select * from tb_electric_process";
        ...
        <button class="btn btn-info" type="submit" name="btadd">บันทึก</button>&nbsp;&nbsp;
              ...
              <a class="btn btn-dark"  href="<?php echo base_url('reportselectric/'. $row['id'] .'?id='. $row['id']) ;?>" target="_Blank">พิมพ์คำแจ้งซ่อมไฟฟ้า</a>&nbsp;&nbsp;
        </div>
