    ...
    <div class="card card-shadow mb-3">
        ...
        <form action="<?php echo $site; ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="group_name" id="group_name"
                               value="<?php echo IsVal($set_data['group_name']) ?>">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-lg-2 text-lg-right">
                ...
                <div class="row mb-2">
                    <div class="col-lg-2 text-lg-right">
                        <b>ลำดับการแสดงผล จากซ้ายไปขวา</b>
                    </div>
                    <div class="col-lg-8">
                        <input type="text" name="list_no" id="list_no" class="form-control"
