...
<head>
    ...
    <title> แจ้งซ่อมประปาสาธารณะ </title>
...
if (!$result) {
    ...
    $id="คำแจ้งซ่อมประปาสาธารณะเลขที่ ".$r['id'];
    ...
    $process=FindRS("select * from tb_waterwork_process where id=".$r['id'],"name");
