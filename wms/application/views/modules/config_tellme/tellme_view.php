...
if(isset($_POST['btadd'])){
    ...
    $strupdate="Update tb_tellme SET typewb='".$_POST['f_status']."',result='$text',updatetime='".date("c")."' Where id='".$last."'";

    $rsupdate=rsQuery($strupdate);

    if($rsupdate){

        echo"<script>alert('บันทึกข้อมูลเรียบร้อย');window.location.href='tellme?_modid=".$modid."&_mod=".$_GET['_mod']."';</script>";
...
$sql="Select * From tb_tellme Where id='".$last."'";
    ...
    <div class="row">
        ...
        <div class="w3-panel w3-border col-md-10">
            ...
            <div class="panel-body">
                ...
                <p>ข้อมูลผู้ร้องเรียน : <?php echo $row['subject'];?></p>

                <p>ข้อมูลผู้ถูกร้องเรียน (เจ้าหน้าที่ในสังกัดเทศบาลตำบลแม่แรม) : <?php echo $row['detail'];?></p>
                ...
                ?>
                <blockquote>
                <p>ลักษณะพฤติกรรมตามการร้องเรียน : <?php echo $row['detail2'];?></p>
                </blockquote>
