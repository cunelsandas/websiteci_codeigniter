<?php
	...
	$a_color=$css['a_color'];
	$a_hover=$css['a_hover'];
	$div_container=$css['div_container'];
	$div_container_width=$css['div_container_width'];

	$div_menutop=$css['div_menutop'];
	$div_content=$css['div_content'];
	$div_sidemenu=$css['div_sidemenu'];
	$a_sidemenu=$css['a_sidemenu'];
	$a_sidemenu_hover=$css['a_sidemenu_hover'];
	$marquee_bg=$css['marquee_bg'];
	$div_header_height=$css['div_header_height'];
	$div_bottom_height=$css['div_bottom_height'];
