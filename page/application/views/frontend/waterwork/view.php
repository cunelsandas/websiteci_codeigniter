...
$sql = "Select * From tb_waterwork Where id='" . $last . "'";
$rs = rsQuery($sql);
...
<div class="container-fluid" style="font-size: 22px">
    <div class="panel panel-default col-md-12" style="border: solid 1px #c3c3c3;border-radius: 12px">
        <h2>แจ้งซ่อมประปาสาธารณะ</h2>
        <div class="panel-body">
            <p>เลขคำร้อง : <?php echo $row['id']; ?></p>
            <p>วันที่แจ้ง : <?php echo $row['datepost']; ?></p>
