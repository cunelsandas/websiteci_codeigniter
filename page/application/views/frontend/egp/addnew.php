...
//                function check โฟดเดอก่อนดาวโหลด ก่อนอัพโหลด
                ...
                $filepathcheck = '../fileupload/electric';
...
//                    echo "<script>alert('The file exists')</script>";
                ...
                $newname = "Electric_Im_" . $_POST['id'] . '_' . $i . '.' . $ext;

                $filetmp = $_FILES["f_image"]["tmp_name"][$i];

                $filetype = $_FILES["f_image"]["type"][$i];

                $filepath = "../fileupload/electric/" . $newname;
                ...
                if (move_uploaded_file($filetmp, $filepath)) {
                    ...
                    $sql = "INSERT INTO tb_files_image_electric(id_image,image_path,image_key) VALUES ('','" . $filepath . "','" . $_POST['f_key'] . "')";
            ...
            $sql = "INSERT INTO tb_electric(id,subject,detail,result,lat,lng,postby,address,email,datepost,ip,typewb,status,updatetime,image_key) Values('','" . $_POST['f_subject'] . "','" . $_POST['f_detail'] . "','','" . $_POST['f_lat'] . "','" . $_POST['f_lng'] . "','" . $_POST['f_name'] . "','" . $_POST['f_address'] . "','" . $_POST['f_email'] . "','" . $_POST['f_dateInput'] . "','" . $_SERVER['REMOTE_ADDR'] . "','1','1','0','" . $_POST['f_key'] . "')";

            $rs = rsQuery($sql);

            if ($rs) {

                echo "<script>alert('เรื่องของคุณได้ถูกส่งไปยังผุ้ที่เกี่ยวข้องแล้วค่ะ');window.location.href='electric';</script>";
...
$sql = "select * from tb_electric order by id desc LIMIT 1";
...
<h4 style="width: 100%;height: 35px; font-weight: bold; text-align: center;margin-left:;background-color:pink;color: white;margin-top: -1.3%;font-size: 1.5rem">แจ้งซ่อมไฟฟ้าสาธารณะ</h4>
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group" style="font-size: 20px">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" style="font-size: 20px" class="form-control" id="f_subject" name="f_subject" value="แจ้งซ่อมไฟฟ้าสาธารณะ" required>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label style="font-size: 20px" class="control-label"><b>รายละเอียดการแจ้งซ่อมไฟฟ้า</b></label>
            ...
            <div class="form-group" style="font-size: 20px">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" name="f_key" id="f_key" value="800<?php echo $newid; ?>">
            ...
            <center>
            <label style="font-size: 20px" class="control-label"><b>ปักหมุดบริเวณที่แจ้งซ่อมไฟฟ้า</b></label>
            </center>
            <div id="map2"></div>
