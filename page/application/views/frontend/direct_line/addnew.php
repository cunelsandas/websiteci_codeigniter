...
//                function check โฟดเดอก่อนดาวโหลด ก่อนอัพโหลด
                ...
                $filepathcheck = '../fileupload/direct_line';
...
//                    echo "<script>alert('The file exists')</script>";
                ...
                $newname = "Direct_Im_" . $_POST['id'] . '_' . $i . '.' . $ext;

                $filetmp = $_FILES["f_image"]["tmp_name"][$i];

                $filetype = $_FILES["f_image"]["type"][$i];

                $filepath = "../fileupload/direct_line/" . $newname;
                ...
                if (move_uploaded_file($filetmp, $filepath)) {
                    ...
                    $sql = "INSERT INTO tb_files_image_direct(id_image,image_path,image_key) VALUES ('','" . $filepath . "','" . $_POST['f_key'] . "')";
            ...
            $sql = "INSERT INTO tb_direct(id,subject,detail,result,lat,lng,postby,address,email,datepost,ip,typewb,status,updatetime,image_key) Values('','" . $_POST['f_subject'] . "','" . $_POST['f_detail'] . "','','" . $_POST['f_lat'] . "','" . $_POST['f_lng'] . "','" . $_POST['f_name'] . "','" . $_POST['f_address'] . "','" . $_POST['f_email'] . "','" . $_POST['f_dateInput'] . "','" . $_SERVER['REMOTE_ADDR'] . "','1','1','0','" . $_POST['f_key'] . "')";

            $rs = rsQuery($sql);

            if ($rs) {

                echo "<script>alert('เรื่องของคุณได้ถูกส่งไปยังผุ้ที่เกี่ยวข้องแล้วค่ะ');window.location.href='direct';</script>";
...
$sql = "select * from tb_direct order by id desc LIMIT 1";
...
<h4 style="width: 100%;height: 35px; font-weight: bold; text-align: center;margin-left:;background-color: pink;color: white;margin-top: -1.3%;font-family: 'FC Lamoon',Serif;font-size: 1.5rem"ิ>สายตรงท่านนายกฯ</h4>
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group" style="font-size: 20px">
                ...
                <div class="col-sm-10">
                    ...
                    <input style="font-size: 18px" type="text" class="form-control" id="f_subject" name="f_subject" required>
            ...
            <div class="form-group" style="font-size: 20px">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="control-label"><b>รายละเอียดการร้องเรียน</b></label>

                    <textarea style="font-size: 18px" type="text" class="form-control" id="f_detail" name="f_detail" required></textarea>
            ...
            <div class="form-group" style="font-size: 20px">
                ...
                <div class="col-sm-10">
                    ...
                    <input style="font-size: 18px" type="text" class="form-control1" id="f_name" name="f_name">
            ...
            <div class="form-group" style="font-size: 20px">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="control-label"><b>ที่อยู่&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b></label>

                    <input style="font-size: 18px" type="text" class="form-control1" id="f_address" name="f_address">
            ...
            <div class="form-group" style="font-size: 20px">
                ...
                <div class="col-sm-10">
                    ...
                    <input style="font-size: 18px" type="text" class="form-control1" id="f_email" name="f_email">
...
<script>
    ...
    function initMap() {
        ...
        myLatLng = {lat: 18.920065, lng: 98.9165782};
