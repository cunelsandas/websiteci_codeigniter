        ...
        <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="card text-white bg-primary mb-3">
                            <div class="card-header">กระทู้ ID [ <?php echo $set['wid']; ?>
                                ]: <?php echo $set['subject']; ?></div>
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo $inform; ?>"
                                   class="btn btn-danger btn-sm float-lg-right btn-inform">แจ้งลบ</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            <div class="card text-white bg-info mb-3">
                                <div class="card-header">RE:: ตอบกระทู้ ID [ <?php echo $ssVal['wid']; ?>
                                    ]: <?php echo $set['subject']; ?></div>
                                <div class="card-body">
            ...
            <div class="row mt-2">
                <div class="col-lg-12 text-center">
                    <a href="javascript:void(0)" onclick="window.history.back()" class="btn btn-outline-secondary">ย้อนกลับ</a>
                </div>
            </div>
        </div>
        <script !src="">
            ...
            $('form').submit(function () {
                ...
                var topic = $('#topic').val() == undefined ? 'topic' : $('#topic').val();
                if (detail == '' || person == '' || topic == '') {
