...
$customer_name = "เทศบาลตำบลแม่แรง";
$customer_tambon="แม่แรง";
$customer_amphur="ป่าซาง";
$customer_province="ลำพุน";
$customer_postcode="51120";
$customer_address="199 หมู่ที่ 2 ";
$customer_tel="<br>E-Mail : ";
$domainname="maerang.go.th";			// ไม่ต้องมี www
$nayok_position ="นายกเทศมนตรีตำบลแม่แรง";
$nayok_name="นายทวี ณ ลำพูน";
$palad_name="";
$showdate="yes"; //แสดงวันที่กำกับ ค่าคือ yes/no
$head_background="<img src=images/head_bg.jpg width=950 height=250>";
$startdate="22/08/2561";  //วันเริ่มนับสถิติ

$egp_code = '5510602'; // รหัสองค์กร
$egp_color = '6b4023'; // รหัสสีไม่ต้องมี #
