...
//                function check โฟดเดอก่อนดาวโหลด ก่อนอัพโหลด
                ...
                if (file_exists($filepathcheck)) {
                    echo "<script>alert('มีการแนปรูปภาพ')</script>";
                } else {
                ...
                $rs = rsQuery($sql);
                if ($rs) {
                    echo "<script>alert('เรื่องของคุณได้ถูกส่งไปยังผุ้ที่เกี่ยวข้องแล้วค่ะ');window.location.href='index';</script>";
...
<h4 style="width: 100%;height: 35px; font-weight: bold; text-align: center;margin-left:;background-color: #ffa7b3;color: white;margin-top: -1.3%;font-size: 1.5rem"ิ>แจ้งเรื่องร้องเรียน / ร้องทุกข์</h4>
    ...
    <div class="col-md-12">
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" style="font-size: 1.35rem">
                    <label class="control-label"><b style="font-size: 16px">วันที่:</b></label>
                    <?php echo date("Y-m-d"); ?>
                    <input type="hidden" name="f_dateInput" id="f_dateInput" value="<?php echo date("c"); ?>"
                </div>
            </div>
            <div class="form-group" style="font-size: 1.35rem">
                <div class="col-sm-10">
            ...
            <div class="form-group" style="font-size: 1.35rem">
                <div class="col-sm-10">
                    ...
                    <input style="font-size: 1.5rem" type="text" class="form-control" id="f_subject" name="f_subject" required>
                </div>
            </div>
            ...
            <div class="form-group" style="font-size: 1.35rem">
                <div class="col-sm-10">
                    ...
                    <textarea style="font-size: 1.5rem" type="text" class="form-control" id="f_detail" name="f_detail" required></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    ...
                    <input style="font-size: 1.5rem" class="form-control" type="text" name="mapsearch" id="mapsearch">
                </div>
            </div>
...
<script>
    function initMap() {
        myLatLng = {lat: 18.9199531, lng: 98.9168185};
