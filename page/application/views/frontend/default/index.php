        ...
        <div class="col-lg-12 col-sm-6">
            <div class="bd-example bd-example-tabs" style="margin-top: -2%">
                <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #fcdee2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="statute-tab" data-toggle="tab" href="#tab-statute" role="tab"
                           aria-controls="statute-tab" aria-selected="false" style="font-size: 1.3rem">เผยแพร่ความรู้เกี่ยวกับพระราชบัญญัติข้อมูลข่าวสารของราชการ พ.ศ. 2540</a>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="myTabContent1">
                    ...
                    <div class="tab-pane fade" id="tab-purchaseegp" role="tabpanel" aria-labelledby="purchase-tab">
                        ...
                        <div class="row mt-1">
                            <div class="col-lg-12 text-right">
                                <a href="egps/egp"><img id="logo-header" src="<?php get_img('getall.png', 'button'); ?>" height="40px;"></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="tab-statute" role="tabpanel" aria-labelledby="statute-tab">
                        <?php
                        $tb_paoannounce = 'tb_files';
                        $paoannounces = $this->db->where('filetypeid', 209)->where('status',1)->limit(5)->order_by('datepost','desc')->get($tb_paoannounce)->result_array();
                        ?>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card" style="border:hidden">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <?php if (count($paoannounces) > 0): ?>
                                                    <?php foreach ($paoannounces AS $apKey => $apVal): ?>
                                                        <a href="<?php echo site_url('file/view/file/' . $apVal['no']) ?>"style="font-size: 1.35rem;color: black"><?php echo "<font color='red'> > </font> {$apVal['subject']}"; ?></a>
                                                        <hr>
                                                    <?php endforeach; ?>
                                                <?php else: ?>
                                                    <div class="text-center">
                        ...
                        <div class="row mt-1">
                            <div class="col-lg-12 text-right">
                                <a href="<?php echo site_url('files/file/209') ?>"><img id="logo-header" src="<?php get_img('getall.png', 'button'); ?>" height="40px;"></a>
                            </div>
                        </div>
                    </div>
...
<!-- <div id="content-executive" class="phone-hide" style="margin-top: -2%;">
    <div class="row mt-5">
        <div class="col-lg-12" style="width:100%">
            <div style="background: url('<?php get_img('executive.png', ''); ?>')top center no-repeat;margin-top: -1.5%;background-size:100% 100% ;min-height: 655px;min-width: auto;">
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-12 text-left" style="margin-left: 80%;margin-top: -3.5%">
