...
<div id="content-advertise" class="container">
    <div class="row mt-3">
        <div class="col-lg-8 mb-4 mb-lg-0">
            <div>
                <h4 style="width: 100%; font-weight: bold; font-style: italic; text-align: center; background: linear-gradient(180deg,orange,white)">ประชาสัมพันธ์</h4>
            </div>
            <div class="card">
        ...
        <div class="col-lg-4 text-lg-left text-center">
            <!-- <h3 style="width: 100%; font-weight: bold; background: linear-gradient(180deg,orange,white)">ช่องทางลัด</h3> -->
            <?php
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="purchase-egp" data-toggle="tab" href="#tab-purchaseegp" role="tab"
                           aria-controls="purchase-tab" aria-selected="false">จัดซื้อจัดจ้าง e-GP</a>
                    </li>
                                            ...
                                            <div class="tab-purchase-<?php echo $ptVal['id'] ?> tab-purchase <?php echo $purchase_hide; ?>">
                                                <?php if (count($purchase_data) > 0): ?>
                                                    <?php foreach ($purchase_data AS $pdKey => $pdVal): ?>
                                                        <a href="<?php echo site_url('purchase/view/purchase/' . $pdVal['no']) ?>"><?php echo "<font color='red'> > </font> {$pdVal['subject']}"; ?></a>
                                                        <hr>
                                                    <?php endforeach; ?>
                                                <?php else: ?>
                                                    <div class="text-center">
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border:hidden">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <h5>ประกาศการจัดซื้อจัดจ้าง e-GP</h5>
                                            </div>
                                            <div class="col-lg-4">
                                                <?php
                                                $purchase_type = $this->db->select('*')->get('tb_purchase_group')->result_array();
                                            ...
                                            <div class="col-lg-12">
                                                <?php if (count($applys) > 0): ?>
                                                    <?php foreach ($applys AS $apKey => $apVal): ?>
                                                        <a href="<?php echo site_url('catalog/view/apply/' . $apVal['no']) ?>"><?php echo "<font color='red'> > </font> {$apVal['subject']}"; ?></a>
                                                        <hr>
                                                    <?php endforeach; ?>
                                                <?php else: ?>
                                                    <div class="text-center">
...
<div id="content-map" class="phone-hide">
    ...
    <div id="content-travel" class="mb-2 phone-hide">
        <div class="text-center">
            ...
            <div style="position:relative;z-index: 6;margin-top: -80px;height:300px;width:100%;background: url('<?php get_img('travel.png', 'map') ?>')top center no-repeat;"></div>
            <div class="container">
                <?php $travel = $this->db->select('*')->where('status', 1)->limit(6)->get('tb_travel')->result_array(); ?>
...
<div id="content-tab-activities" class="phone-hide">
    ...
    <div class="container">
        <?php $video = $this->db->where('active', 1)->limit(6)->get('tb_youtube')->result_array();
        $cVideo = count($video) > 3 ? 3 : count($video); ?>
...
?>
<table class='table table-sm' style='margin-bottom: 0rem;font-size: 1em;'>
    <thead>
    <tr>
