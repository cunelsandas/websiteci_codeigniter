...
//$mail->SMTPSecure = 'tls'; // บรรทัดนี้ ให้ Uncomment ไว้ เพราะ Mail Server ของโฮสต์ ไม่รองรับ SSL.
...
$mail->SetFrom($fm, "SYSTEM ITGLOBAL");
$mail->AddAddress("migarlza00@gmail.com");
